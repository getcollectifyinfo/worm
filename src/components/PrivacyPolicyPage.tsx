...
export const PrivacyPolicyPage: React.FC<PrivacyPolicyPageProps> = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      <Helmet>
        <title>Gizlilik Politikası - CadetPrep Academy</title>
        <meta name="description" content="CadetPrep Academy gizlilik politikası ve veri güvenliği bilgileri." />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">Gizlilik Politikası</h1>
